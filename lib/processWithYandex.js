let translatorByYandex = {
    ...
    getLinkForGetTranslate: function(wordForTranslate, apiKey) {
        if (!isDefined(wordForTranslate) || wordForTranslate === null || typeof wordForTranslate !== 'string' || wordForTranslate.trim().length === 0) {
            return null;
        }
    ...
    translateComplete: function(response) {
        ...
        if (isDefined(response) && response !== null && response.code === 200) {
